sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("whr/com/br/ZLARTrocaTurno/app", ".html");
	...
	return Opa5.extend("whr.com.br.ZLARTrocaTurno.test.integration.arramgements.Arrangement", {
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			return this.waitFor({
				success : function() {
					oOptions.hash = "/DESCHORARIOSet/" + encodeURIComponent(sObjectId);
